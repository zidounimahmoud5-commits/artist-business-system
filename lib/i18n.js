...
export const DICT = {
  en: {
    ...
    nav: { dashboard: "Dashboard", artworks: "Artworks", pricing: "Pricing", commissions: "Commissions", clients: "Clients", exhibitions: "Exhibitions", sales: "Sales", expenses: "Expenses", contracts: "Contracts", settings: "Settings", more: "More", logout: "Log out" },
    ...
    pricing: { title: "Smart Pricing Calculator", inputs: "Inputs", materialCost: "Material cost", laborHours: "Labor hours", laborRate: "Hourly rate", frameCost: "Frame", packagingCost: "Packaging", shippingCost: "Shipping", otherCosts: "Other costs", margin: "Desired profit margin (%)", galleryCommission: "Gallery commission (%)", results: "Results", totalCost: "Total production cost", directPrice: "Direct sale price", galleryPrice: "Gallery price", minPrice: "Minimum acceptable price", expectedProfit: "Expected profit (direct)", profitMargin: "Profit margin", useCalculator: "Use these numbers for a new artwork" },
    commissions: { title: "Commission Manager", add: "+ Add commission", empty: "No commissions yet.", client: "Client", concept: "Concept", size: "Size", medium: "Medium", price: "Price", deposit: "Deposit", remaining: "Remaining balance", deadline: "Deadline", status: "Status", daysLeft: "days left", overdue: "OVERDUE", notes: "Notes", save: "Save commission" },
  ...
  ar: {
    ...
    nav: { dashboard: "لوحة التحكم", artworks: "الأعمال الفنية", pricing: "التسعير", commissions: "الأعمال المطلوبة", clients: "العملاء", exhibitions: "المعارض", sales: "المبيعات", expenses: "المصاريف", contracts: "العقود", settings: "الإعدادات", more: "المزيد", logout: "تسجيل الخروج" },
